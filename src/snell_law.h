    ...
    std::vector<double> &first_edge_intersection_point_z_list)
{
    ...
    // this is how we calculate the result
    // i_x = first_edge_x_2 + a * edge_vector_x - source_x
    // i_y = first_edge_y_2 + a * edge_vector_y - source_y
    // i_z = first_edge_z_2 + a * edge_vector_z - source_z

    // t_x = destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x
    // t_y = destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y
    // t_z = destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z

    // ===

    // i_length = sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2)

    // t_length =sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2)

    // ===

    // i_x = (first_edge_x_2 + a * edge_vector_x - source_x)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2))

    // i_y = (first_edge_y_2 + a * edge_vector_y - source_y)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2))

    // i_z = (first_edge_z_2 + a * edge_vector_z - source_z)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2))

    // ===

    // t_x = (destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2))

    // t_y = (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2))

    // t_z = (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2))
    ...
    // x:
    // = first_face_first_edge_normal_vector_y * (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2)) - first_face_first_edge_normal_vector_z * (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2))

    // n * i =

    // x:
    // = first_face_first_edge_normal_vector_y * (first_edge_z_2 + a * edge_vector_z - source_z)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2)) - first_face_first_edge_normal_vector_z * (first_edge_y_2 + a * edge_vector_y - source_y)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2))

    // ===

    // n * t = (n_1/n_2) * n * i

    // effective_weight_ratio_of_remaining_face_over_first_face * n * t = n * i

    // syms effective_weight_ratio_of_remaining_face_over_first_face source_x source_y source_z destination_on_first_face_x destination_on_first_face_y destination_on_first_face_z first_edge_x_1 first_edge_y_1 first_edge_z_1 first_edge_x_2 first_edge_y_2 first_edge_z_2 first_face_first_edge_normal_vector_x first_face_first_edge_normal_vector_y first_face_first_edge_normal_vector_z edge_vector_x edge_vector_y edge_vector_z a;

    // [a]=solve(effective_weight_ratio_of_remaining_face_over_first_face * (first_face_first_edge_normal_vector_y * (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2)) -…
    //     first_face_first_edge_normal_vector_z * (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)/(sqrt((destination_on_first_face_x - first_edge_x_2 - a * edge_vector_x)^2 + (destination_on_first_face_y - first_edge_y_2 - a * edge_vector_y)^2 + (destination_on_first_face_z - first_edge_z_2 - a * edge_vector_z)^2)))==…
    //     first_face_first_edge_normal_vector_y * (first_edge_z_2 + a * edge_vector_z - source_z)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2))-…
    //     first_face_first_edge_normal_vector_z * (first_edge_y_2 + a * edge_vector_y - source_y)/(sqrt((first_edge_x_2 + a * edge_vector_x - source_x)^2 + (first_edge_y_2 + a * edge_vector_y - source_y)^2 + (first_edge_z_2 + a * edge_vector_z - source_z)^2)), [a]);

    // roots(a)

    // ====

    // syms mu sx sy sz dx dy dz x1 y1 z1 x2 y2 z2 nx ny nz ex ey ez a;

    // [a]=solve(mu * (ny * (dz - z2 - a * ez)/(sqrt((dx - x2 - a * ex)^2 + (dy - y2 - a * ey)^2 + (dz - z2 - a * ez)^2)) -...
    //     nz * (dy - y2 - a * ey)/(sqrt((dx - x2 - a * ex)^2 + (dy - y2 - a * ey)^2 + (dz - z2 - a * ez)^2)))==...
    //     ny * (z2 + a * ez - sz)/(sqrt((x2 + a * ex - sx)^2 + (y2 + a * ey - sy)^2 + (z2 + a * ez - sz)^2)) - ...
    //     nz * (y2 + a * ey - sy)/(sqrt((x2 + a * ex - sx)^2 + (y2 + a * ey - sy)^2 + (z2 + a * ez - sz)^2)), [a]);

    // [a]=solve(mu * (ny * (dz - z2 - a * ez) - nz * (dy - y2 - a * ey)) / (sqrt((dx - x2 - a * ex)^2 + (dy - y2 - a * ey)^2 + (dz - z2 - a * ez)^2)) ==…
    //     (ny * (z2 + a * ez - sz) - nz * (y2 + a * ey - sy))/(sqrt((x2 + a * ex - sx)^2 + (y2 + a * ey - sy)^2 + (z2 + a * ez - sz)^2)), [a]);
    ...
    // syms mu sx sy sz x3 y3 z3 x4 y4 z4 nx ny nz ex ey ez a;

    // [a]=solve(mu * (ny * (z3 - a * ez)/(sqrt((x3 - a * ex)^2 + (y3 - a * ey)^2 + (z3 - a * ez)^2)) -...
    //     nz * (y3 - a * ey)/(sqrt((x3 - a * ex)^2 + (y3 - a * ey)^2 + (z3 - a * ez)^2)))==...
    //     ny * (z4 + a * ez)/(sqrt((x4 + a * ex)^2 + (y4 + a * ey)^2 + (z4 + a * ez)^2)) - ...
    //     nz * (y4 + a * ey)/(sqrt((x4 + a * ex)^2 + (y4 + a * ey)^2 + (z4 + a * ez)^2)), [a]);

    // [a]=solve(mu * (ny * (z3 - a * ez) - nz * (y3 - a * ey)) / (sqrt((x3 - a * ex)^2 + (y3 - a * ey)^2 + (z3 - a * ez)^2)) ==…
    //     (ny * (z4 + a * ez) - nz * (y4 + a * ey))/(sqrt((x4 + a * ex)^2 + (y4 + a * ey)^2 + (z4 + a * ez)^2)), [a]);

    // [a]=solve(mu * (ny * z3 - a * ny * ez - nz * y3 + a * nz * ey) / (sqrt((x3 - a * ex)^2 + (y3 - a * ey)^2 + (z3 - a * ez)^2)) ==…
    //     (ny * z4 + a * ny * ez - nz * y4 - a * nz * ey)/(sqrt((x4 + a * ex)^2 + (y4 + a * ey)^2 + (z4 + a * ez)^2)), [a]);
    ...
    // [a]=solve(mu^2 * (p1 + a * q1)^2 / ((x3 - a * ex)^2 + (y3 - a * ey)^2 + (z3 - a * ez)^2) ==…
    //     (p2 + a * q2)^2/((x4 + a * ex)^2 + (y4 + a * ey)^2 + (z4 + a * ez)^2), [a]);

    // [a]=solve(mu^2 * (p1 + a * q1)^2 / (a^2 * ex^2 - a * 2 * x3 * ex + x3^2 + a^2 * ey^2 - a * 2 * y3 * ey + y3^2 + a^2 * ez^2 - a * 2 * z3 * ez + z3^2) ==…
    //     (p2 + a * q2)^2/(a^2 * ex^2 + a * 2 * x4 * ex + x4^2 + a^2 * ey^2 + a * 2 * y4 * ey + y4^2 + a^2 * ez^2 + a * 2 * z4 * ez + z4^2), [a]);

    // ===>
    // k0 = ex^2 + ey^2 + ez^2;
    // k1 = -2 * x3 * ex - 2 * y3 * ey - 2 * z3 * ez;
    // k2 = x3^2 + y3^2 + z3^2;
    // k3 = 2 * x4 * ex + 2 * y4 * ey + 2 * z4 * ez;
    // k4 = x4^2 + y4^2 + z4^2;

    // [a]=solve(mu^2 * (p1 + a * q1)^2 / (a^2 * k0 + a * k1 + k2) ==…
    //     (p2 + a * q2)^2/(a^2 * k0 + a * k3 + k4), [a]);

    // [a]=solve(mu^2 * (a^2 * q1^2 + a * 2 * p1 * q1 + p1^2) / (a^2 * k0 + a * k1 + k2) ==…
    //     (a^2 * q2^2 + a * 2 * p2 * q2 + p2^2)/(a^2 * k0 + a * k3 + k4), [a]);
    ...
    // [a]=solve(mu^2 * (a^2 * m1 + a * m2 + m3) / (a^2 * k0 + a * k1 + k2) ==…
    //     (a^2 * n1 + a * n2 + n3)/(a^2 * k0 + a * k3 + k4), [a]);

    // [a]=solve(mu^2 * (a^2 * m1 + a * m2 + m3) * (a^2 * k0 + a * k3 + k4) ==…
    //     (a^2 * n1 + a * n2 + n3) * (a^2 * k0 + a * k1 + k2), [a]);

    // [a]=solve(mu^2 * (a^4 * m1 * k0 + a^3 * m1 * k3 + a^2 * m1 * k4 + a^3 * m2 * k0 + a^2 * m2 * k3 + a * m2 * k4 + a^2 * m3 * k0 + a * m3 * k3 + m3 * k4) ==…
    //     a^4 * n1 * k0 + a^3 * n1 * k1 + a^2 * n1 * k2 + a^3 * n2 * k0 + a^2 * n2 * k1 + a * n2 * k2 + a^2 * n3 * k0 + a * n3 * k1 + n3 * k2, [a]);

    // [a]=solve(mu^2 * (a^4 * m1 * k0 + a^3 * (m1 * k3 + m2 * k0) + a^2 * (m1 * k4  + m2 * k3 + m3 * k0) + a * (m2 * k4 + m3 * k3) + m3 * k4) ==…
    //     a^4 * n1 * k0 + a^3 * (n1 * k1 + n2 * k0) + a^2 * (n1 * k2  + n2 * k1 + n3 * k0) + a * (n2 * k2  + n3 * k1) + n3 * k2, [a]);

    // [a]=solve(a^4 * mu^2 * m1 * k0 + a^3 * (mu^2 * m1 * k3 + mu^2 * m2 * k0) + a^2 * (mu^2 * m1 * k4  + mu^2 * m2 * k3 + mu^2 * m3 * k0) + a * (mu^2 * m2 * k4 + mu^2 * m3 * k3) + mu^2 * m3 * k4 ==…
    //     a^4 * n1 * k0 + a^3 * (n1 * k1 + n2 * k0) + a^2 * (n1 * k2  + n2 * k1 + n3 * k0) + a * (n2 * k2  + n3 * k1) + n3 * k2, [a]);

    // [a]=solve(a^4 * (mu^2 * m1 * k0 - n1 * k0) + a^3 * (mu^2 * m1 * k3 + mu^2 * m2 * k0 - n1 * k1 - n2 * k0) + a^2 * (mu^2 * m1 * k4  + mu^2 * m2 * k3 + mu^2 * m3 * k0 - n1 * k2  - n2 * k1 - n3 * k0) + a * (mu^2 * m2 * k4 + mu^2 * m3 * k3 - n2 * k2  - n3 * k1) + (mu^2 * m3 * k4 - n3 * k2) == 0, [a]);

    // ===>
    // v1 = mu^2 * m1 * k0 - n1 * k0;
    // v2 = mu^2 * m1 * k3 + mu^2 * m2 * k0 - n1 * k1 - n2 * k0;
    // v3 = mu^2 * m1 * k4  + mu^2 * m2 * k3 + mu^2 * m3 * k0 - n1 * k2  - n2 * k1 - n3 * k0;
    // v4 = mu^2 * m2 * k4 + mu^2 * m3 * k3 - n2 * k2  - n3 * k1;
    // v5 = mu^2 * m3 * k4 - n3 * k2;

    // [a]=solve(a^4 * v1 + a^3 * v2 + a^2 * v3 + a * v4 + v5 == 0, [a]);
